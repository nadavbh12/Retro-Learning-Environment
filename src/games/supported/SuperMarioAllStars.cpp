...
RomSettings* SuperMarioAllStarsSettings::clone() const {
    RomSettings* rval = new SuperMarioAllStarsSettings();
    *rval = *this;
    return rval;
}
...
void SuperMarioAllStarsSettings::reset() {
...
void SuperMarioAllStarsSettings::saveState( Serializer & ser ) {
  ser.putInt(m_reward);
  ser.putInt(m_score);
  ser.putInt(m_lives);
...
void SuperMarioAllStarsSettings::loadState( Deserializer & des ) {
  m_reward = des.getInt();
  m_score = des.getInt();
  m_lives = des.getInt();
