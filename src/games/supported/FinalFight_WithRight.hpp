...
#ifndef __FINAL_FIGHT_WITH_RIGHT_SETTINGS_HPP__
#define __FINAL_FIGHT_WITH_RIGHT_SETTINGS_HPP__
...
struct FinalFightWithRightSettings : public SnesSettings {

    public:

	FinalFightWithRightSettings();
	...
	// the rom-name
	const char* rom() const { return "final_fight_with_right"; }
...
#endif // __FINAL_FIGHT_WITH_RIGHT_SETTINGS_HPP__
