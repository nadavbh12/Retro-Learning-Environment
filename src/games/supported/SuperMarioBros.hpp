...
#ifndef __SUPER_MARIO_BROS_HPP__
#define __SUPER_MARIO_BROS_HPP__
...
struct SuperMarioBrosSettings : public NesSettings {

    public:

	SuperMarioBrosSettings();
        ...
        // the rom-name
        const char* rom() const { return "super_mario_bros"; }
...
#endif // __SUPER_MARIO_BROS_SETTINGS_HPP__
