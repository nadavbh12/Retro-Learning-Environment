...
#ifndef __SONIC_THE_HEDGEHOG_SETTINGS_HPP__
#define __SONIC_THE_HEDGEHOG_SETTINGS_HPP__
...
class SonicTheHedgehogSettings : public GenesisSettings {

    public:

		SonicTheHedgehogSettings();

        // reset
        void reset();

        // the rom-name
        const char* rom() const { return "sonic_the_hedgehog"; }
...
#endif // __SONIC_THE_HEDGEHOG_SETTINGS_HPP__
