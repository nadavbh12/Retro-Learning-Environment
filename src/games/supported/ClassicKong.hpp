...
#ifndef __CLASSIC_KONG_SETTINGS_HPP__
#define __CLASSIC_KONG_SETTINGS_HPP__
...
class ClassicKongSettings : public SnesSettings {
    ...
    public:
        ...
        // the rom-name
        const char* rom() const { return "classic_kong"; }
...
#endif // __CLASSIC_KONG_SETTINGS_HPP__
