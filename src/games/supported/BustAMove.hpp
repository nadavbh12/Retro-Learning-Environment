...
#ifndef __BUST_A_MOVE_SETTINGS_HPP__
#define __BUST_A_MOVE_SETTINGS_HPP__
...
class BustAMoveSettings : public SnesSettings {
    ...
    public:
        ...
        // the rom-name
        const char* rom() const { return "bust_a_move"; }
...
#endif // __BUST_A_MOVE_SETTINGS_HPP__
