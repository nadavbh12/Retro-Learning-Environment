...
//
//    // is an action legal on SNES. to be called be inheriting roms
//    bool isLegal(const Action &a) const;
//
//
//    static SnesActionsVector SnesAllActionsVector;
//};
//
//// this is a class to allow constructor for static member
//class SnesActionsVector{
//public:
//	SnesActionsVector();
//
//	ActionVect SnesAllActionsVector;
//};
//
//
