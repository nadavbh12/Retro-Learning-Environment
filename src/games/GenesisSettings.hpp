 ...
 * *****************************************************************************
 */
#ifndef __GENESIS_SETTINGS_HPP__
#define __GENESIS_SETTINGS_HPP__
...
// rom support interface for genesis
struct GenesisSettings : public RomSettings{
    GenesisSettings();

	virtual ~GenesisSettings() {}
...
#endif // __GENESIS_SETTINGS_HPP__
