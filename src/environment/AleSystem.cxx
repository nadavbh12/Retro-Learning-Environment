...
//
// $Id: AleSystem.cxx,v 1.108 2007/08/17 16:12:50 stephena Exp $
//============================================================================
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
/* ALE
bool AleSystem::createFrameBuffer(bool showmessage)
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void AleSystem::toggleFrameBuffer()
{
#ifdef DISPLAY_OPENGL
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
//bool AleSystem::createConsole(const string& romfile)
//{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
//bool AleSystem::openROM(const string& rom, string& md5, uInt8** image, int* size)
//{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
//string AleSystem::getROMInfo(const string& romfile)
//{
//  ostringstream buf;
//
//  // Open the cartridge image and read it in
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
//bool AleSystem::queryConsoleInfo(const uInt8* image, uInt32 size,
//                               const string& md5,
...
/* ALE
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void AleSystem::setDefaultJoymap()
{
  EventMode mode;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void AleSystem::setDefaultJoyAxisMap()
{
  EventMode mode;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void AleSystem::setDefaultJoyHatMap()
{
// FIXME - add emul and UI events
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void AleSystem::pollEvent()
{
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
bool AleSystem::joyButtonHandled(int button)
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
void AleSystem::stateChanged(EventHandler::State state)
{
}
ALE */
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
/* ALE
void AleSystem::queryVideoHardware()
{
...
*/
/* ALE
uInt32 AleSystem::ourGUIColors[kNumUIPalettes][kNumColors-256] = {
  // Standard
