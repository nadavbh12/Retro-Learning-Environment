...
static void rle_rearrangeRgb(uint8_t *dst_buffer, const uint32_t *src_buffer, size_t src_size , const RLEInterface *rle) {
...
void getScreenRGB(RLEInterface *rle, unsigned char *output_buffer){
  ...
  rle_rearrangeRgb(output_buffer, (uint32_t*)screen.getArray(), size_in_pixels, rle);
}
